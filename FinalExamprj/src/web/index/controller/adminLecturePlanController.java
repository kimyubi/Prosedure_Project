...
@WebServlet("/adminlecturedetail")
public class adminLecturePlanController extends HttpServlet{
	...
	request.getRequestDispatcher("/adminlecturedetail.jsp").forward(request, response);
