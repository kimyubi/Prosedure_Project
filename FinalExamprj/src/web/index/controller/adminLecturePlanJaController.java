...
@WebServlet("/adminlecturedetailJa")
public class adminLecturePlanJaController extends HttpServlet{
	...
	request.getRequestDispatcher("/adminlecturedetailJa.jsp").forward(request, response);
