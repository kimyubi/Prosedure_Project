...
@WebServlet("/adminLectureEvaluation")
public class adminLectureEvaluationController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/adminlectureEvaluation.jsp").forward(request, response);
   //검색 기능을 구현하기 위한 코드 
}
}
