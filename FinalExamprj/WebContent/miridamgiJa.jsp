...
<nav class="navbar navbar-default  navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="/miridamgiJa">미리담기</a></li>
...
<input  style=" margin-left: 50px; margin-bottom: 15px; width: 200px; background-color:#F0F0F0;" class="btn btn-search" value="인문 캠퍼스"  onclick = "location.href = '/miridamgi' "/> 
<input  style=" margin-left: 5px; margin-bottom : 15px; width: 200px; background-color: silver ;" class="btn btn-search"  value="자연 캠퍼스"  onclick = "location.href = '/miridamgiJa' "/> 


		<form class="table-form" action="/miridamgiJa" method="get" style="margin-left: 100px; width: 1200px;">
...
<main class="main">
	   ...
	   <form action="/miridamgiJa" method="post"  >
