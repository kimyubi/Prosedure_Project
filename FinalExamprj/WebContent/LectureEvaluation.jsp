...
<!------------------------------------------------------------------------------ css ----------------------------------------------------------------->
 ...
 function openRegLectureEvaluation(){
	 window.name = "LectureEvaluation"; //부모 창 이름 지정
	  window.open("RegLectureEvaluation.jsp", "RegLectureEvaluation", "width=600, height=580, resizable=no, scrollbars=no");
	 //새 창을 여는 함수, 속성: 생성된 새 창의 url, 생성된 창의 이름, 창 옵션 설정,
  }
